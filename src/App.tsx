...
function App() {
	...
	return (
		<div className=" flex max-w-5xl h-full m-auto">
			<div className="flex-none w-64 h-fit text-left mt-28 text-neutral-300 text-sm font-medium">
			...
			<div className="grow">
				<div className='border-solid border border-neutral-800 mb-8 bg-black rounded-xl mt-10'>
					<button className='bg-neutral-800 px-5 m-5 text-white p-1 rounded-md' onClick={() => clickHandler(0)}>Description</button>
					<button className='bg-neutral-800 px-5 m-5 text-white p-1 rounded-md' onClick={() => clickHandler(1)}>Demo</button>
					<button className='bg-neutral-800 px-5 m-5 text-white p-1 rounded-md' onClick={() => clickHandler(2)}>Code</button>
					<button className='bg-neutral-800 px-5 m-5 text-white p-1 rounded-md' onClick={() => clickHandler(2)}>Solution</button>
				</div>
				{step === 0 && (
					<div id='aa' className='text-left border-solid border border-neutral-800 text-white bg-black rounded-xl text-xs p-8'></div>
				)}
				{step === 1 && (
					<Challenge1 />
				)}
